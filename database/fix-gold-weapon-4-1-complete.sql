...
SELECT 
  'product_composition 확인' as step,
  id,
  name,
  slug
...
WHERE (slug = 'gold-weapon4' 
   ...
   OR slug = 'weapon-gold-4-1'
   OR slug LIKE '%weapon%gold%4%')
   AND slug != 'secret-weapon-gold-4-1';

-- ============================================
-- 3단계: product_composition 테이블 slug 업데이트
-- ============================================
