...
async function testNaverBlogScraper() {
  console.log('🚀 네이버 블로그 스크래퍼 테스트 시작...');
  ...
  try {
    ...
    try {
      ...
      console.log('✅ 스크래핑 결과 섹션이 표시되었습니다.');
      ...
      console.log('⚠️ 스크래핑 결과가 아직 표시되지 않았습니다.');
    }
    ...
    try {
      ...
      console.log('✅ URL 모드 스크래핑도 성공적으로 완료되었습니다.');
    } catch (error) {
      console.log('⚠️ URL 모드 스크래핑 결과가 아직 표시되지 않았습니다.');
    }
...
testNaverBlogScraper().catch(console.error);
