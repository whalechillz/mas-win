...
export default async function handler(req, res) {
  ...
  try {
    console.log('📝 9월 22일 블로그 포스트 생성 중...');
    
    const blogPost = {
      title: '골프 입문 3개월, 70대 할아버지의 MASSGOO 드라이버 첫 경험기',
      slug: 'golf-beginner-3months-70s-grandfather-massgoo-driver-first-experience',
      content: `# 골프 입문 3개월, 70대 할아버지의 MASSGOO 드라이버 첫 경험기
...
*본 후기는 실제 고객의 경험을 바탕으로 작성되었습니다. 개인차가 있을 수 있습니다.*`,
      ...
      status: 'published',
      author: '마쓰구골프',
      meta_title: '골프 입문 3개월, 70대 할아버지의 MASSGOO 드라이버 첫 경험기',
      meta_description: '70세 골프 입문자가 MASSGOO 드라이버로 3개월 만에 40m 비거리 증가를 경험한 실제 후기. 시니어 골퍼를 위한 맞춤 피팅과 초고반발 드라이버의 효과를 확인하세요.',
      meta_keywords: '골프 입문, 70대 골퍼, MASSGOO, 드라이버, 시니어 골퍼, 맞춤 피팅, 초고반발 드라이버, 골프 후기, 비거리 증가',
      featured_image: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80',
      created_at: '2025-09-22T10:00:00.000Z'
    };

    console.log('💾 9월 22일 블로그 포스트 저장 중...');
    ...
    console.log('✅ 9월 22일 블로그 포스트가 성공적으로 생성되었습니다!');
    
    return res.status(200).json({ 
      success: true, 
      message: '9월 22일 블로그 포스트가 성공적으로 생성되었습니다!',
      blogPost: {
    ...
    console.error('❌ 9월 22일 블로그 포스트 생성 중 오류 발생:', error);
