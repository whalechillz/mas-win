...
async function testMigrationButton() {
  console.log('🚀 마이그레이션 버튼 테스트 시작...');
  ...
  try {
    ...
    try {
      ...
      console.log('✅ 마이그레이션 버튼 테스트 완료!');
      
    } catch (error) {
      console.log('❌ 마이그레이션 버튼을 찾을 수 없습니다:', error.message);
    }
...
testMigrationButton().catch(console.error);
