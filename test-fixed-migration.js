...
async function testFixedMigration() {
  ...
  try {
    ...
    try {
      ...
      if (dateValue) {
        console.log('✅ 작성일 필드가 정상적으로 표시되었습니다!');
      } else {
        console.log('⚠️ 작성일 필드가 비어있습니다.');
      }
...
testFixedMigration().catch(console.error);
