...
function selectBrandKeyword() {
  // 마쓰구 → 마스골프 브랜드 전환에 따른 키워드 선택
  const brandOptions = ['masgoo', 'massgoo', 'masgolf'];
  return brandOptions[Math.floor(Math.random() * brandOptions.length)];
}
