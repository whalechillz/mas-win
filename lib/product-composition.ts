...
export const PRODUCTS_FOR_COMPOSITION: ProductForComposition[] = [
  {
    ...
    imageUrl: '/main/products/gold2-sapphire/마쓰구_시크리트포스_골드_2_500.png',
    slug: 'gold2-sapphire',
    badge: 'BEST',
  ...
  },
  {
    ...
    category: 'MUZIIK 협업 제품',
    imageUrl: '/main/products/black-beryl/마쓰구_시크리트웨폰_블랙_500.png',
    slug: 'black-beryl',
    badge: 'LIMITED',
  ...
  },
  {
    ...
    category: '프리미엄 드라이버',
    imageUrl: '/main/products/gold2/마쓰구_시크리트포스_골드_2_500.png',
    slug: 'gold2',
    badge: 'BEST',
  ...
  },
  {
    ...
    category: '고반발 드라이버',
    imageUrl: '/main/products/pro3/마쓰구_시크리트포스_PRO_500.png',
  ...
  },
  {
    ...
    category: '투어 드라이버',
    imageUrl: '/main/products/v3/마쓰구_시크리트포스_V3_350_bg.png',
  ...
  },
  {
    ...
    category: '프리미엄 리미티드',
    imageUrl: '/main/products/black-weapon/마쓰구_시크리트웨폰_블랙_500.png',
  ...
  },
  {
    ...
    category: '프리미엄 드라이버',
    imageUrl: '/main/products/gold-weapon4/마쓰구_시크리트웨폰_4.1_500.png',
