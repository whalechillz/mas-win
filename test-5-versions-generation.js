...
(async () => {
  ...
  try {
    ...
    await page.screenshot({ path: 'test-5-versions-generation-result.png', fullPage: true });
    console.log('✅ 스크린샷 저장 완료: test-5-versions-generation-result.png');

    await browser.close();
    console.log('✅ 5개 버전 생성 테스트 완료!');
