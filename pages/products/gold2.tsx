...
export default function Gold2Product() {
  ...
  // 제품 데이터 로드
  const { productImages, galleryImages, isLoadingProduct } = useProductData('secret-force-gold-2', defaultImages);
  ...
  const images = productImages.length > 0 ? productImages : defaultImages;

  return (
    <>
      <Head>
        <title>시크리트포스 골드 2 | MASGOLF</title>
        <meta name="description" content="DAT55G+ Grade 5 티타늄, 2.2mm 초박형 페이스, COR 0.87" />
      </Head>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                <div>
                  <h1 className="text-4xl font-bold mb-2">시크리트포스 골드 2</h1>
                  <p className="text-xl text-gray-600 mb-4">프리미엄 드라이버</p>
