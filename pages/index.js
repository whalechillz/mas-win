...
export default function Home({ hostname }) {
  ...
  const products = [
    ...
    },
    {
      ...
      images: [
        '/main/products/black-weapon/마쓰구_시크리트웨폰_블랙_공홈_00_01.webp',
        '/main/products/black-weapon/마쓰구_시크리트웨폰_블랙_공홈_01.webp',
        '/main/products/black-weapon/마쓰구_시크리트웨폰_블랙_공홈_02.webp',
        '/main/products/black-weapon/마쓰구_시크리트웨폰_블랙_공홈_03.webp',
        '/main/products/black-weapon/마쓰구_시크리트웨폰_블랙_공홈_04.webp',
        '/main/products/black-weapon/마쓰구_시크리트웨폰_블랙_공홈_05.webp',
        '/main/products/black-weapon/마쓰구_시크리트웨폰_블랙_공홈_06.webp',
        '/main/products/black-weapon/마쓰구_시크리트웨폰_블랙_공홈_07.webp',
        '/main/products/black-weapon/마쓰구_시크리트웨폰_블랙_공홈_08_01.webp',
      ],
    ...
    },
    {
      ...
      features: ['SP700 Grade 5 티타늄', '2.2mm 초박형 페이스', 'COR 0.87'],
      images: [
        '/main/products/gold-weapon4/마쓰구_시크리트웨폰_4.1_공홈_00_01.webp',
        '/main/products/gold-weapon4/마쓰구_시크리트웨폰_4.1_공홈_01.webp',
        '/main/products/gold-weapon4/마쓰구_시크리트웨폰_4.1_공홈_02.webp',
        '/main/products/gold-weapon4/마쓰구_시크리트웨폰_4.1_공홈_03.webp',
        '/main/products/gold-weapon4/마쓰구_시크리트웨폰_4.1_공홈_04.webp',
        '/main/products/gold-weapon4/마쓰구_시크리트웨폰_4.1_공홈_05.webp',
        '/main/products/gold-weapon4/마쓰구_시크리트웨폰_4.1_공홈_06.webp',
        '/main/products/gold-weapon4/마쓰구_시크리트웨폰_4.1_공홈_07.webp',
        '/main/products/gold-weapon4/마쓰구_시크리트웨폰_4.1_공홈_08_01.webp',
      ],
      badges: null,
      borderColor: null,
    },
