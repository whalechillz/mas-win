  ...
  cookies: {
    sessionToken: {
      ...
      options: {
        ...
        // 도메인 설정: 프로덕션에서는 .masgolf.co.kr로 설정하여 서브도메인 간 공유
        // www.masgolf.co.kr에서 설정된 쿠키는 .masgolf.co.kr 도메인으로 설정해야 함
        // 하지만 실제로는 도메인을 명시하지 않으면 현재 도메인에서만 작동
        // 따라서 undefined로 설정하여 현재 도메인(www.masgolf.co.kr)에서만 작동하도록 함
