...
const SMS_TEMPLATES = {
  booking_received: `친애하는 {고객명} 고객님, 
안녕하세요! 마쓰구골프입니다.
고객님의 시타 예약 요청이 접수되었습니다!

▶ 예약 가능 여부 확인 후 연락드리겠습니다.
▶ 예약 요청 일시: {날짜} {시간}

한 번의 시타로 최대 비거리 증가를 직접 체험하세요!
...
OPEN 09:00~17:00(월~금)`,
  booking_confirmed: `친애하는 {고객명} 고객님, 
안녕하세요! 마쓰구골프입니다.
고객님의 특별한 시타 예약을 환영합니다. 고객님만을 위해 특별히 준비한 맞춤형 분석과 시타 체험을 통해 최상의 경험을 선사해 드리겠습니다.
...
[시타 서비스 혜택]
⊙ 정밀 클럽 분석: 기존 사용 클럽을 바탕으로 스윙 특성, 비거리, 구질을 세밀하게 분석해 드립니다.
⊙ 비거리/구질 향상 체크: 고객님께 꼭 맞는 골프 드라이버를 제안드리고, 성능을 직접 체험해보실 수 있습니다.
⊙ 마쓰구의 최대 비거리 맞춤 클럽을 추천해 드립니다.
...
무료 080-028-8888 (무료 상담)
OPEN 09:00~17:00(월~금)`,
  booking_reminder_2h: `친애하는 {고객명} 고객님, 
안녕하세요! 마쓰구골프입니다.
...
// 날짜 포맷팅 (예: 2025-11-27 → 2025년 11월 27일(화))
