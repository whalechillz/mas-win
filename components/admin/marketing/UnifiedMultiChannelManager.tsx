...
import { Plus, Edit, Trash2, Eye, Tag, Calendar, User, CheckCircle, AlertCircle, Clock, Settings, Palette, Zap, Filter, RefreshCw } from 'lucide-react';
import { AIGenerationSettings } from './AIGenerationSettings';

// 통합 멀티채널 매니저 - 심플한 UI + 테마/AI 기능
