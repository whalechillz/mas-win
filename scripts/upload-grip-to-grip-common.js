/**
 * 다운로드 폴더의 그립.webp를 grip-common/composition/stm-grip-35g.webp로 업로드
 */
...
const TARGET_FOLDER = 'originals/products/grip-common/composition';
const SOURCE_FILE = '그립.webp';
const TARGET_FILE = 'stm-grip-35g.webp';
