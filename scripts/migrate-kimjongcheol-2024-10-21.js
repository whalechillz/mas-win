/**
 * 김종철 고객 이미지 마이그레이션 스크립트 (2024.10.21)
 * 
 * 1. 고객 사진 1장 (장면 1)
 * 2. 가이드 사진 3장 (장면 4)
 * 3. 시타 사진 2장 (장면 5)
...
const CUSTOMER_INFO = {
  name: '김종철',
  phone: '010-8888-6654',
  visitDate: '2024-10-21',
  nameEn: 'kimjongcheol', // DB에서 확인 필요
  initials: 'KJC'
};
...
// 이미지 파일 매핑
const IMAGE_MAPPING = {
  'customer.jpeg': { scene: 1, imageType: 'hero' },
  'guide_01.JPG': { scene: 4, imageType: 'guide-meeting' },
  'guide_02.JPG': { scene: 4, imageType: 'guide-meeting' },
  'guide_03.jpeg': { scene: 4, imageType: 'guide-meeting' },
  'try_01.JPG': { scene: 5, imageType: 'swing' },
  'try_02.JPG': { scene: 5, imageType: 'swing' }
};
...
async function migrateImages(customerInfo) {
  ...
  console.log(`📁 타입별:`);
  console.log(`   - 고객 사진: ${typeCounts['hero']}개`);
 ...
 * 메인 마이그레이션 함수
 */
async function migrateKimJongCheol() {
  console.log('🚀 김종철 고객 이미지 마이그레이션 시작...\n');
  ...
  // 최종 요약
  console.log('\n' + '='.repeat(60));
  console.log('✅ 김종철 고객 이미지 마이그레이션 완료!');
  console.log('='.repeat(60));
