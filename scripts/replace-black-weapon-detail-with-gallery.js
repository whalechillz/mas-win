/**
 * black-weapon 제품의 detail 폴더를 gallery 이미지로 대체
...
async function replaceBlackWeaponDetailWithGallery() {
  ...
  try {
    ...
    // 결과 저장
    const outputPath = path.join(__dirname, 'black-weapon-detail-to-gallery-replacement-result.json');
...
replaceBlackWeaponDetailWithGallery();
