/**
 * gold2-sapphire 제품의 detail 폴더에서 2-01.webp 파일 삭제
 */
...
const product = {
  folder: 'gold2-sapphire',
  slug: 'gold2-sapphire',
  name: '시크리트포스 골드 2 MUZIIK'
};

async function deleteGold2SapphireFile() {
  console.log(`🗑️  ${product.name} detail 폴더에서 2-01.webp 삭제...\n`);

  const fileName = '2-01.webp';
