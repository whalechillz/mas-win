/**
 * pro3 제품의 detail 폴더를 gallery 이미지로 대체
...
async function replacePro3DetailWithGallery() {
  ...
  try {
    ...
    // 결과 저장
    const outputPath = path.join(__dirname, 'pro3-detail-to-gallery-replacement-result.json');
