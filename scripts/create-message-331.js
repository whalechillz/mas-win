/**
 * 솔라피 그룹 ID를 기반으로 메시지 ID 331을 생성하는 스크립트
 * 
 * 사용법:
 * node scripts/create-message-331.js
 */
...
const groupId = "G4V202601091315233K6PCP4AGS44MSJ";
const messageId = 331;
...
async function createMessage331() {
  console.log(`\n🔄 메시지 ID 331 생성 및 동기화 시작...\n`);
