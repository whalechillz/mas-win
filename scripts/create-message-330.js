/**
 * 솔라피 그룹 ID를 기반으로 메시지 ID 330을 생성하는 스크립트
 * 
 * 사용법:
 * node scripts/create-message-330.js
 */
...
const groupId = "G4V20260109130213IZ8HQE5KSMZVC9K";
const messageId = 330;
...
async function createMessage330() {
  console.log(`\n🔄 메시지 ID 330 생성 및 동기화 시작...\n`);
