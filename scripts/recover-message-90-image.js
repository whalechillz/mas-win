/**
 * 90번 메시지의 이미지 복구 스크립트
 * 솔라피 API를 통해 이미지를 가져와서 복구
 * 
 * 사용법:
 * node scripts/recover-message-90-image.js
 */
...
async function recoverMessage90Image() {
  console.log('🔄 90번 메시지 이미지 복구 시작...\n');
  ...
  try {
    ...
    console.log('💡 SMS 편집 페이지에서 확인하세요: /admin/sms?id=90\n');
